...
void FillModule (pybind11::module_& m)
{
    ...
    stimulusBase.def (init<> (&std::make_shared<Stimulus>))
        ...
        .def_readwrite ("rngCompute_shaderSource", &Stimulus::rngCompute_shaderSource, "RNG Compute shader workgroup size x..")
        .def_readwrite ("rngCompute_workGroupSizeX", &Stimulus::rngCompute_workGroupSizeX, "RNG Compute shader workgroup size X.")
        .def_readwrite ("rngCompute_workGroupSizeY", &Stimulus::rngCompute_workGroupSizeY, "RNG Compute shader workgroup size Y.")
        .def_readwrite ("rngCompute_seed", &Stimulus::rngCompute_seed, "RNG Compute seed.")
        .def_readwrite ("rngCompute_multiLayer", &Stimulus::rngCompute_multiLayer, "Enable buffer layers for each frame in flight.")
