...
class DogFftFreqSpec(Component, gears.SpatialFilter) :
    ...
    def update(
        ...
        print('U')
        pixelScale = -self.seq.fft_width_px * self.seq.fft_height_px / self.seq.getSpatialFilteredFieldWidth_um() / self.seq.getSpatialFilteredFieldHeight_um();
